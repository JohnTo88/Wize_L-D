...
public class Test_FunctionalAccess_ProjectManagementPermission_TargetVolume extends TestManager {
	HomePage homePage;
	WebDriver driver;
	...
	public void TT_971() throws InterruptedException {
		...
		administration.openRolesTab();
		TestLogger.info("3. Create Automation User Role Name and Role Type is Admin :");
		UserRoleName = "Project Management|Target Volume|Update" + TienIch.taoRandomSo(3);
		roles.createUserRoleNameWithRoleTypeAdmin(UserRoleName);
		...
		addProjectBoard.addProjectBoard("B" + TienIch.taoRandomSo(6), TienIch.taoRandomSo(4), "08-Sep-2019");
