...
public class Test_FunctionalAccess_ProjectManagementPermission_ProjectDetail_ImportMembertoProject extends TestManager {
	HomePage homePage;
	WebDriver driver;
	...
	public void TT_980() throws InterruptedException {
		...
		UserRoleName = "ProjectManagement|ImportMemberToProject|Read" + TienIch.taoRandomSo(3);
