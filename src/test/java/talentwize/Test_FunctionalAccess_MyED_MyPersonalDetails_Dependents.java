...
public class Test_FunctionalAccess_MyED_MyPersonalDetails_Dependents extends TestManager {
	...
	@Test(priority = 1)
	public void TT_1579() throws InterruptedException {
		...
		UserRoleName = "Automation|Dependents|NoPermission" + TienIch.taoRandomSo(4);

		roles.createUserRoleNameWithRoleTypeAdmin(UserRoleName);

		TestLogger.info("4. Checked on My Employee Data Permision -My Personal Details - Dependents |NO permission");
		...
		if (personalDetails.isTableDependentsDisplayed() == false) {
			setStatusTest("pass", "User CANNOT see/do: " + "Dependents block");

		} else {
			setStatusTest("fail", "User STILL CAN see/do: " + "Dependents block");
		}
	}

	@Test(priority = 2)
	public void TT_1610() throws InterruptedException {
		TestLogger.info("1. Login with Administrator account.");
		homePage.SignInWith(propertyManager.getEmailAdmin(), propertyManager.getPasswordAdmin());
		...
		TestLogger.info("3. Create Automation User Role Name and Role Type is Admin :");
		UserRoleName = "Automation|Dependents|Create" + TienIch.taoRandomSo(1);

		roles.createUserRoleNameWithRoleTypeAdmin(UserRoleName);

		TestLogger.info("4. Checked on My Employee Data Permision -My Personal Details - Dependents | Read");
		roles.uncheckbox_Read_My_PersonalDetails_Dependents();

		roles.checkbox_Create_My_PersonalDetails_Dependents();
	...
	@Test(priority = 3)
	public void TT_1608() throws InterruptedException {
		TestLogger.info("1. Login with Administrator account.");
		homePage.SignInWith(propertyManager.getEmailAdmin(), propertyManager.getPasswordAdmin());
		...
		roles.checkbox_Read_My_PersonalDetails_Dependents();
	...
	@Test(priority = 4)
	public void TT_1609() throws InterruptedException {
		TestLogger.info("1. Login with Administrator account.");
		homePage.SignInWith(propertyManager.getEmailAdmin(), propertyManager.getPasswordAdmin());
		...
		TestLogger.info("3. Create Automation User Role Name and Role Type is Admin :");
		UserRoleName = "Automation|Dependents|Update" + TienIch.taoRandomSo(4);

		roles.createUserRoleNameWithRoleTypeAdmin(UserRoleName);

		TestLogger.info("4. Checked on My Employee Data Permision -My Personal Details - Dependents |Update");
		roles.uncheckbox_Read_My_PersonalDetails_Dependents();

		roles.checkbox_Update_My_PersonalDetails_Dependents();
	...
	@Test(priority = 5)
	public void TT_1611() throws InterruptedException {
		TestLogger.info("1. Login with Administrator account.");
		homePage.SignInWith(propertyManager.getEmailAdmin(), propertyManager.getPasswordAdmin());
		...
		TestLogger.info("3. Create Automation User Role Name and Role Type is Admin :");
		UserRoleName = "Automation|Dependents|Delete" + TienIch.taoRandomSo(4);

		roles.createUserRoleNameWithRoleTypeAdmin(UserRoleName);

		TestLogger.info("4. Checked on My Employee Data Permision -My Personal Details - Dependents |Delete");
		roles.uncheckbox_Read_My_PersonalDetails_Dependents();

		roles.checkbox_Delete_My_PersonalDetails_Dependent();
