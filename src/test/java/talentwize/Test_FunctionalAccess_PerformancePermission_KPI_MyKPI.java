...
public class Test_FunctionalAccess_PerformancePermission_KPI_MyKPI extends TestManager {
	HomePage homePage;
	WebDriver driver;
	...
	public void TT_1154() throws InterruptedException {
		...
		UserRoleName = "PerformancePermission|KPI|My KPI|No permission" + TienIch.taoRandomSo(3);
	...
	public void TT_1150() throws InterruptedException {
		...
		TestLogger.info("3. Create Automation User Role Name and Role Type is Admin :");
		UserRoleName = "Performance Permission|KPI|My KPI|Read" + TienIch.taoRandomSo(3);
		roles.createUserRoleNameWithRoleTypeAdmin(UserRoleName);
