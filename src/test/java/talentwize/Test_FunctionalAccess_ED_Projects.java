...
public class Test_FunctionalAccess_ED_Projects extends TestManager {
	...
	@Test(priority = 1)
	public void TT_956() throws InterruptedException {
		...
		TestLogger.info("+  ED - Projects | No permission");
	...
	@Test(priority = 2)
	public void TT_832() throws InterruptedException {
		TestLogger.info("1. Login with Administrator account.");
		homePage.SignInWith(propertyManager.getEmailAdmin(), propertyManager.getPasswordAdmin());
	...
	@Test(priority = 3)
	public void TT_838() throws InterruptedException {
		TestLogger.info("1. Login with Administrator account.");
		homePage.SignInWith(propertyManager.getEmailAdmin(), propertyManager.getPasswordAdmin());
		...
		TestLogger.info("Create Automation User Role Name and Role Type is Admin :");
		UserRoleName = "ED|Project|Create" + TienIch.taoRandomSo(3);
		...
		TestLogger.info("+  ED-Projects| Create");
		roles.uncheck_Read_ED_Projects();
		roles.check_Read_ED_Projects();

		TestLogger.info("+ Check on ED - Projects | Create");
		roles.check_Create_ED_Projects();
		TestLogger.info("5. Click Save button");
		roles.clickButtonSave();
		...
		administration.clickMenuEmployeeList();
		employeeList.searchEmployees("Nguyen Viet Nam");
		employeeList.clickEmployeeNguyenVietNam();
		...
		formAddEmployeeToTheProject.addEmployeeToTheProject("auto test");

		if (projects.isTxtAddedSusscessfulDisplayed() == true) {
	...
	@Test(priority = 4)
	public void TT_840() throws InterruptedException {
		TestLogger.info("1. Login with Administrator account.");
		homePage.SignInWith(propertyManager.getEmailAdmin(), propertyManager.getPasswordAdmin());
		...
		roles.check_View_Employees();
		roles.check_Update_EmployeeInformation();
		TestLogger.info("+  ED-Projects|Update");
		roles.uncheck_Read_ED_Projects();
		roles.check_Read_ED_Projects();

		TestLogger.info("+ Check on ED - Projects | Update");
		roles.check_Update_ED_Projects();
		TestLogger.info("5. Click Save button");
		roles.clickButtonSave();
	...
	@Test(priority = 5)
	public void TT_841() throws InterruptedException {
		TestLogger.info("1. Login with Administrator account.");
		homePage.SignInWith(propertyManager.getEmailAdmin(), propertyManager.getPasswordAdmin());
		...
		TestLogger.info("Create Automation User Role Name and Role Type is Admin :");
		UserRoleName = "ED|Project|Delete" + TienIch.taoRandomSo(3);
		...
		roles.check_View_Employees();
		roles.check_Update_EmployeeInformation();
		TestLogger.info("+  ED-Projects|Delete");
		roles.uncheck_Read_ED_Projects();
		roles.check_Read_ED_Projects();
