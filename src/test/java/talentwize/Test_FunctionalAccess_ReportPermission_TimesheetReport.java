...
public class Test_FunctionalAccess_ReportPermission_TimesheetReport extends TestManager {
	HomePage homePage;
	WebDriver driver;
	...
	public void TT_1249() throws InterruptedException {
		...
		UserRoleName = "ReportPermission|TimesheetReport|NoPermission" + TienIch.taoRandomSo(3);
	...
	public void TT_1248() throws InterruptedException {
		...
		TestLogger.info("3. Create Automation User Role Name and Role Type is Admin :");
		UserRoleName = "ReportPermission|TimesheetReport|Read" + TienIch.taoRandomSo(3);
		roles.createUserRoleNameWithRoleTypeAdmin(UserRoleName);
